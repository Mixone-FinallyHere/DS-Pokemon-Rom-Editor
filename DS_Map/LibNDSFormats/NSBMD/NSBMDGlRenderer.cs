...
namespace LibNDSFormats.NSBMD {
    ...
    public class NSBMDGlRenderer {
        ...
        private List<HelixToolkit.MeshBuilder> md = new List<HelixToolkit.MeshBuilder>();
        ...
        private List<ImageBrush> matt = new List<ImageBrush>();
        private List<ImageBrush> mattt = new List<ImageBrush>();
        ...
        private int lastselectedanim = -2;
